    ...
    if (!service) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-[#0a0a0a] text-white p-6">
                <h1 className="text-4xl font-bold mb-4 text-cyan-500">Service Not Found</h1>
                <p className="text-gray-400 mb-8">The service you're looking for doesn't exist.</p>
                <Link href="/" className="px-8 py-3 bg-cyan-500 hover:bg-cyan-600 rounded-xl font-bold transition-all">
                    Return Home
                </Link>
            </div>
        );
